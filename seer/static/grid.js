...
function lightMode() {
    ...
    document.getElementById("themeToggle").textContent = isDark ? "Shift the veil" : "Return to night"
    textColor = isDark ? "#b0b0b0" : "#3f3f3f"
    signColorAlpha = isDark ? 0.4 : 0.2
    legend()
    if (lastState) {
        drawSeries(lastState)
    }
}
